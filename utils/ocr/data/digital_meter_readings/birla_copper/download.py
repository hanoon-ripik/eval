...
def process_raw_json_and_download():
    """
    Process raw.json file and create clean.json with downloaded images.
    """
    print("Processing raw.json and downloading images...")
    ...
    for i, item in enumerate(items_to_process):
        ...
        # Extract original_image URL
        original_image_url = item.get('original_image', '')
        if not original_image_url:
            print(f"Warning: No original_image found for item {i}")
            continue
...
def main():
    ...
    """
    print("Birla Copper Data Processing Script")
    print("=" * 40)
